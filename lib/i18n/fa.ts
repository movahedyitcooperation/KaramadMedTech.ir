...
export const fa = {
  ...
  admin: {
    ...
    orders: {
      ...
      viewButton: "مشاهده",
      backToList: "بازگشت به لیست سفارش‌ها",
      sectionAddress: "آدرس ارسال",
      sectionItems: "اقلام سفارش",
      colProduct: "کالا",
      colSku: "کد محصول",
      colUnitPrice: "قیمت واحد",
      colQty: "تعداد",
      colLineTotal: "جمع",
      productDeleted: "(محصول حذف‌شده)",
      sectionSummary: "خلاصه مبلغ",
      subtotalLabel: "جمع کالاها",
      shippingLabel: "هزینه ارسال",
      shippingFree: "رایگان",
      totalLabel: "مبلغ نهایی",
      sectionStatus: "وضعیت سفارش",
      statusUpdateButton: "ثبت تغییر وضعیت",
      updating: "در حال ثبت…",
      noFurtherTransitions: "این سفارش به وضعیت نهایی رسیده و قابل تغییر نیست",
      invalidTransitionError: "این تغییر وضعیت برای سفارش با وضعیت فعلی مجاز نیست",
      statusLabels: {
        pending_payment: "در انتظار پرداخت",
        paid: "پرداخت‌شده",
        processing: "در حال آماده‌سازی",

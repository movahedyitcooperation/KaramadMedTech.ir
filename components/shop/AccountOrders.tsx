 ...
 * every detail lives one click away on /orders/[id]. There is no date column
 * because OrderRead does not expose the order's created_at; the order number
 * is the only chronological cue available today (noted in
        ...
        return (
          ...
          >
            <div className="flex min-w-45 flex-col gap-2">
              ...
              <span className="text-sm text-ink/58">{fa.orders.itemCount(itemCount)}</span>
            </div>
